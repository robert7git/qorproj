...
func (App) ConfigureAdmin(Admin *admin.Admin) {
	...
	ROOTMENU := "Products Management"

	// Produc Management
	Admin.AddMenu(&admin.Menu{Name: ROOTMENU, Priority: 1})
	color := Admin.AddResource(&products.Color{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -5})
	Admin.AddResource(&products.Size{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -4})
	Admin.AddResource(&products.Material{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -4})

	category := Admin.AddResource(&products.Category{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -3})
	category.Meta(&admin.Meta{Name: "Categories", Type: "select_many"})

	collection := Admin.AddResource(&products.Collection{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -2})

	// Add ProductImage as Media Libraray
	ProductImagesResource := Admin.AddResource(&products.ProductImage{}, &admin.Config{Menu: []string{ROOTMENU}, Priority: -1})
	...
	// Add Product
	product := Admin.AddResource(&products.Product{}, &admin.Config{Menu: []string{ROOTMENU}})
